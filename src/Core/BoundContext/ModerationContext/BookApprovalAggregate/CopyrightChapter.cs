...
public class CopyrightChapter 
{
    ...
    private CopyrightChapter(string chapterTitle, string chapterContent/*string? signatureValue,
    ...
    public static CopyrightChapter Create(
        string chapterTitle, string chapterContent/*,  string signatureValue,
        string signatureAlgorithm*/,string chapterSlug, int chapterNumber)
    {
        return new CopyrightChapter(chapterTitle, chapterContent
    ...
    {
        return new CopyrightChapter(chapterTitle, chapterContent, null, null ,chapterSlug, chapterNumber);
    }*/
