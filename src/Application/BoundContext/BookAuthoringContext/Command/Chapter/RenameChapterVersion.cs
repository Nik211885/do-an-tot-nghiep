...
public class RenameChapterVersionCommandHandler(
    ...
    : ICommandHandler<RenameChapterVersionCommand, ChapterViewModel>
{
    ...
    public async Task<ChapterViewModel> Handle(RenameChapterVersionCommand request, CancellationToken cancellationToken)
    {
